...
//     'A',
//   ]
//   return `${values[this.value]} of ${suits[this.suit]}`; //${suits[this.suit][0].toUpperCase()}${suits[this.suit].slice(1)}}`;
// }
//
//
...
//   }
// }
//// math.random is some number between 0 and 1, not including 1; (i + 1) caps the random number at but not including 53; math.floor rounds down to whole number
...
//   this.player1.hand = this.deck.cards.filter((item, index) => !(index %2));
//     //w/o => function: (function(item, index){return !(index %2)});
...
// }
//
// //need to add compare method to Game constructor via prototype
//
